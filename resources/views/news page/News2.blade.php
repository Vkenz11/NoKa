...
<body style="background-color: #141313">
    ...
    <div class="events-container">
        <div class="events-container-pic">
            <img src="../picture references/News/map.jpg">
        </div>

        <div class="events-container-content">
            <p>
                A new monster appearance has been added! A new monster 
                appearance has been added!A new monster appearance has 
                been added! A new monster appearance has been added!
            </p>
        </div>
    </div>
</body>
