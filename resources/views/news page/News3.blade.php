...
<body style="background-color: #141313">
    ...
    <div class="events-container">
        <div class="events-container-pic">
            <img src="../picture references/News/person.jpg">
        </div>

        <div class="events-container-content">
            <p>
                For a while now, we have been asking ourselves 
                "How can we get more people to play our game?" 
                Today we are happy to announce that we have found an 
                answer. We have been working on a new strategy, 
                which will allow us to make games that are much more 
